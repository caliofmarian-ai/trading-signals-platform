...
def _decision(kind: str, signal_id: str, candle_ts: int) -> DecisionObject:
    tier = {"PRE": "SCORE_PRE_BAND", "CONFIRM": "SCORE_CONFIRM_BAND", "OPEN_NOW": "SCORE_OPEN_BAND"}[kind]
...
def test_pre_and_confirm_persist_one_opportunity_identity() -> None:
...
def test_same_stage_and_candle_do_not_rewrite_persistent_state() -> None:
...
def test_open_now_becomes_candidate_without_false_live_sent_state() -> None:
