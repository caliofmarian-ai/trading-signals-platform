...
def build_status_snapshot(
    ...
    return {
        ...
        "strategy_evaluation_count": evidence.get("strategy_evaluation_count"),
        "last_strategy_evaluation_ts": evidence.get("last_strategy_evaluation_ts"),
        "last_strategy_symbol": evidence.get("last_strategy_symbol"),
        "last_strategy_candle_ts": evidence.get("last_strategy_candle_ts"),
        "last_strategy_decision_kind": evidence.get("last_strategy_decision_kind"),
        "last_strategy_score_total": evidence.get("last_strategy_score_total"),
        "last_strategy_score_tier": evidence.get("last_strategy_score_tier"),
        "last_strategy_tps": evidence.get("last_strategy_tps"),
        "last_strategy_hard_blockers": evidence.get("last_strategy_hard_blockers"),
