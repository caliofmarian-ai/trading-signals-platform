...
Version: 2.0.0  
Status: CANONICAL  
Path: /opt/binarybot/docs/canonical/active/ROLE_AND_PERMISSION_MATRIX_SPEC_v2.0.0.md
...
This must align with `OBSERVABILITY_LOGGING_SPEC_v2.0.0.md` and related audit documents.
...
This v2.0.0 specification replaces that with:
...
End of ROLE_AND_PERMISSION_MATRIX_SPEC_v2.0.0.md
