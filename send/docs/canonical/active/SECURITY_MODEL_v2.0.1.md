...
- `send/docs/canonical/active/SECURITY_MODEL_v2.0.0.md` — historical predecessor superseded by this active canonical patch.  
...
The executed canonical promotion makes this v2.0.1 patch authoritative; `SECURITY_MODEL_v2.0.0.md` remains a historical predecessor.
...
|---|---|---|
| 2.0.1 | 2026-09-01 | Active PATCH successor: canonical reference repair plus removal of duplicate legacy RBAC/outcome-window constants in favor of their authoritative domain owners. |
| 2.0.0 | 2026-07-12 | Historical predecessor promoted under OWNER-006 = A before supersession by v2.0.1. |
