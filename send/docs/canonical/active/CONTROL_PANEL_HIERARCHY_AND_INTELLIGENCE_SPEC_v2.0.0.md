...
This v2.0.0 document replaces the older flatter panel framing with:
...
- compatibility with future AI/research/reporting layers without collapsing RBAC boundaries
...
This sublayer must align with `DECISION_AUDIT_SPEC_v2.0.0.md`.
...
This must remain aligned with `OBSERVABILITY_LOGGING_SPEC_v2.0.0.md` and related audit specs.
...
## 19. RELATION TO FUTURE AI / RESEARCH EXPANSION

The panel is expected to evolve to include stronger AI, research and reporting capabilities.
...
However, all such future surfaces must still obey:
...
This v2.0.0 specification replaces that with a clearer canonical model centered on:
...
End of CONTROL_PANEL_HIERARCHY_AND_INTELLIGENCE_SPEC_v2.0.0.md

## 18. Control-Plane UX Clarifications from Admin UX Review

This section absorbs bounded control-plane clarifications extracted from ADMIN_UX_V2_SPEC.md.

### 18.1 Hierarchical fit
...
### 18.2 Presentation vs authority
