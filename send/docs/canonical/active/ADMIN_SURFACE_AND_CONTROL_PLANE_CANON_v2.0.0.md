...
|---|---|---|
| `ADMIN_CONTROL_SPEC_v2.0.0.md` | Primary implementation spec | Admin command surface, command validation, role enforcement, Telegram control interface |
| `ADMIN_OPERATIONS_SPEC_v2.0.0.md` | Operations spec | Day-to-day operational procedures, runbook-style admin actions, operational state transitions |
| `ADMIN_TREE_MAP_v2.0.0.md` | Structural map | Hierarchical map of the admin control surface, topic/command routing layout |
| `CONTROL_PANEL_HIERARCHY_AND_INTELLIGENCE_SPEC_v2.0.0.md` | Intelligence integration | Control panel structure, intelligence layer consumption, display and drill-down surfaces |
| `ROLE_AND_PERMISSION_MATRIX_SPEC_v2.0.0.md` | Permission authority | Role definitions, permission matrix, access boundaries for each role |
| `STRATEGY_PARAMETER_CONTROL_SPEC_v2.0.0.md` | Parameter governance | Admin authority over strategy parameters, controlled parameter change procedures |

**Ordering of authority within the cluster:**

1. This root manifest (`ADMIN_SURFACE_AND_CONTROL_PLANE_CANON_v2.0.0.md`) — establishes architectural principles and hierarchy; governs when cluster members conflict.
2. `ROLE_AND_PERMISSION_MATRIX_SPEC_v2.0.0.md` — governs role definitions and access control for all other cluster members.
3. `ADMIN_CONTROL_SPEC_v2.0.0.md` — governs the command surface and Telegram control interface.
4. `ADMIN_OPERATIONS_SPEC_v2.0.0.md` — governs operational procedures within constraints set by ADMIN_CONTROL_SPEC.
5. `ADMIN_TREE_MAP_v2.0.0.md` — maps the structural layout; must be consistent with ADMIN_CONTROL_SPEC and ADMIN_OPERATIONS_SPEC.
6. `CONTROL_PANEL_HIERARCHY_AND_INTELLIGENCE_SPEC_v2.0.0.md` — governs display and intelligence integration within the control surface.
7. `STRATEGY_PARAMETER_CONTROL_SPEC_v2.0.0.md` — governs parameter changes; must comply with role restrictions in ROLE_AND_PERMISSION_MATRIX_SPEC.

**No cluster member may:**
- Declare a role hierarchy that contradicts this document or `ROLE_AND_PERMISSION_MATRIX_SPEC_v2.0.0.md`.
- Define admin command behavior that contradicts `ADMIN_CONTROL_SPEC_v2.0.0.md`.
- Establish parameter change procedures that contradict `STRATEGY_PARAMETER_CONTROL_SPEC_v2.0.0.md`.
...
- `send/docs/canonical/active/DECISION_OBJECT_CANONICAL_SPEC_v1.0.0.md`
- `send/docs/canonical/active/FSM_DECISION_ENGINE_SPEC_v1.0.0.md`
- `send/docs/canonical/active/SR_CORRIDOR_ENGINE_SPEC_v2.0.0.md`
- `send/docs/canonical/active/TIME_MODEL_UNIFIED_CANON_v2.0.0.md`
...
- `send/docs/canonical/active/AFFILIATE_SIGNAL_DISTRIBUTION_MODEL_v2.0.0.md`
...
This document does not redefine the strategy, FSM, Signal Engine, or Observability.
...
Actual emission to destinations lives here:
...
Role-level details (permissions, command access, restrictions) are governed by `ROLE_AND_PERMISSION_MATRIX_SPEC_v2.0.0.md`.
...
- Command validation is governed by `ADMIN_CONTROL_SPEC_v2.0.0.md`
- Topic layout is governed by `ADMIN_TREE_MAP_v2.0.0.md`

### 7.2 Debug and Health Dashboard

A specialized read-only display surface for system state.

- Governed by `CONTROL_PANEL_HIERARCHY_AND_INTELLIGENCE_SPEC_v2.0.0.md`
- Must not allow command execution
- Must consume observability truth from `OBSERVABILITY_SPEC_v2.0.0.md` and `OBSERVABILITY_LOGGING_SPEC_v2.0.0.md`

### 7.3 Strategy Parameter Control

Controlled parameter update surface.

- Governed by `STRATEGY_PARAMETER_CONTROL_SPEC_v2.0.0.md`
- Changes require role authorization per `ROLE_AND_PERMISSION_MATRIX_SPEC_v2.0.0.md`
...
- Governed by `AFFILIATE_SIGNAL_DISTRIBUTION_MODEL_v2.0.0.md`
- Must not expose internal truth plane data
- Access restricted to distribution and performance metrics

### 7.5 Operations Surface

Runbook-style operational controls.

- Governed by `ADMIN_OPERATIONS_SPEC_v2.0.0.md`
...
The human control plane must consume observability data — not produce it.
...
- Observability data is governed by `OBSERVABILITY_SPEC_v2.0.0.md` (policy) and `OBSERVABILITY_LOGGING_SPEC_v2.0.0.md` (implementation)
- Admin cannot override observability conclusions; it can only act on them

---

## 9. AFFILIATE AND ADMIN SEGMENTATION

The affiliate layer is a distribution consumer, not a control plane actor.

Rules:

- Affiliates may view their own distribution performance metrics
- Affiliates may not access internal strategy, FSM, or scoring data
- Affiliate admin functions are governed by `AFFILIATE_SIGNAL_DISTRIBUTION_MODEL_v2.0.0.md`
- No affiliate role may hold admin permissions in the control plane

---

## 10. CHANGE CONTROL FOR CONTROL PLANE MODIFICATIONS

Any modification to the human control plane must comply with `GOVERNANCE_AND_CHANGE_CONTROL_v2.0.0.md`.
...
Admin-level controls (require ADMIN role):
...
## 15. CANONICAL VERSION HISTORY

| Version | Date | Description |
|---|---|---|
| 2.0.0 | 2026-07-12 | Promoted to active canonical status as root manifest for admin/control-plane cluster (OWNER-007 = A, canonical-reconciliation-01). Cluster authority map added. Cluster member relationships declared and ordered. Canonical paths updated. |
