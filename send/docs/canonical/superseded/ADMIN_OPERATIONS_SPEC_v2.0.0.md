...
Version: 2.0.0  
Status: CANONICAL  
Path: /opt/binarybot/docs/canonical/active/ADMIN_OPERATIONS_SPEC_v2.0.0.md
...
This v2.0.0 document replaces the legacy operator-control framing with a governed, role-scoped, domain-structured operational procedure model aligned to the current BinaryBot architecture.

---

End of ADMIN_OPERATIONS_SPEC_v2.0.0.md

## 26. Admin Operator Workflow Clarifications from Admin UX Review

This section absorbs bounded workflow clarifications extracted from ADMIN_UX_V2_SPEC.md.
