# AFFILIATE_SIGNAL_DISTRIBUTION_MODEL_v2.0.0

Version: 2.0.0  
Status: Active Canonical  
Path: /opt/binarybot/docs/canonical/active/AFFILIATE_SIGNAL_DISTRIBUTION_MODEL_v2.0.0.md
...
The AFFILIATE_ADMIN role must remain aligned with the canonical role hierarchy and permission model.

## 5. Affiliate Position in the Admin Hierarchy

The affiliate role sits below owner-level and principal-admin authority.

Canonical authority principle:
- Owner remains supreme authority.
- Principal admin and approved functional admins control governance and platform operations.
...
## 8. Referral Identity and Attribution
...
## 10. Subscriber Attribution Rule
...
## 12. Subscription Conversion Model
...
## 17. Privacy and Permission Boundary
...
## 21. Suspension and Restriction Rule
...
## 25. Relationship to Signal Distribution
...
- which signal stages are routed
- which tiers receive what
...
The affiliate model must never override the canonical distribution architecture.

## 26. Relationship to Monetization Model

This document is subordinate to and complementary with the active signal economics and monetization model.
...
## 27. Relationship to Role and Permission Model

Affiliate permissions must be implemented through the canonical role model, not through ad hoc exceptions.
...
## 29. Relationship to Outcome and Performance Layers
...
Affiliate reporting must not expose raw decision-audit detail, internal strategy reasoning, or sensitive outcome internals that belong to system research or elite user workflows.
...
If an affiliate-related change affects runtime behavior, payout processing, entitlement logic, dashboard visibility, or admin controls, it must follow the active deployment protocol.
...
## 35. Final Enforcement Statement
