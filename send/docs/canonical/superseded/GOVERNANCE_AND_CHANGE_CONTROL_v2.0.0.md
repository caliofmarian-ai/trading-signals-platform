# GOVERNANCE_AND_CHANGE_CONTROL_v2.0.0

Version: 2.0.0  
Status: Active Canonical  
Path: /opt/binarybot/docs/canonical/active/GOVERNANCE_AND_CHANGE_CONTROL_v2.0.0.md
...
This document does not define trading logic internals, channel copywriting, or subsystem implementation details.  
...
Parameter Authority must operate under evidence discipline.
...
A structural logic change alters ownership, decision rules, lifecycle rules, architecture, or subsystem interaction.
...
Interpretation:
- PATCH = bug fix or non-structural correction
- MINOR = controlled parameter-level or bounded behavior tuning
- MAJOR = structural architecture or logic change
...
This document is the authoritative governance and change-control framework for the project. 0

## 22. Privacy Protection and Pseudonymous Member References

This section integrates bounded privacy governance from the merged Community Feedback and Privacy intake.

### 22.1 Raw identifier exposure prohibition
...
### 22.2 Pseudonymous member reference rule
MEMBER_REF may be derived as a salted pseudonymous identifier (for example, MEMBER_REF = hash(telegram_user_id + secret_salt)) so that analytics, audits, and community-facing references can operate without exposing raw identity.

### 22.3 Protected fields
Members must never see privileged identity fields such as raw telegram_user_id values for other members. Privacy controls in governance and change-control review must preserve this invariant.
