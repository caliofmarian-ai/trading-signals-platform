...
Path: /opt/binarybot/docs/canonical/active/CANONICAL_STRATEGY_STACK_v1.0.0.md  
Version: 1.0.0  
...
1. canonical/active/ALGO_SPEC_v2.0.0.md
...
Au prioritate:
1. canonical/active/FSM_DECISION_ENGINE_SPEC_v1.0.0.md
2. canonical/active/DECISION_OBJECT_CANONICAL_SPEC_v1.0.0.md
3. canonical/active/ALGO_SPEC_v2.0.0.md

### 11.3 Dacă există conflict despre outputul strategiei
Au prioritate:
1. canonical/active/DECISION_OBJECT_CANONICAL_SPEC_v1.0.0.md
2. canonical/active/FSM_DECISION_ENGINE_SPEC_v1.0.0.md
3. canonical/active/SIGNAL_ENGINE_EXECUTION_SPEC_v2.0.0.md
...
- patch de output strategy → canonical/active/DECISION_OBJECT_CANONICAL_SPEC_v1.0.0.md
- patch de FSM → canonical/active/FSM_DECISION_ENGINE_SPEC_v1.0.0.md
- patch de emitere semnal → canonical/active/SIGNAL_ENGINE_EXECUTION_SPEC_v2.0.0.md
...
1. patch canonical/active/ALGO_SPEC_v2.0.0.md
2. patch canonical/active/DECISION_OBJECT_CANONICAL_SPEC_v1.0.0.md
3. patch canonical/active/FSM_DECISION_ENGINE_SPEC_v1.0.0.md
4. patch canonical/active/SR_CORRIDOR_ENGINE_SPEC_v2.0.0.md
5. patch canonical/active/SIGNAL_ENGINE_EXECUTION_SPEC_v2.0.0.md
6. patch canonical/active/OBSERVABILITY_SPEC_v2.0.0.md
