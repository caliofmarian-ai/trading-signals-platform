...
merge_note:
This intake document was merged in bounded form into active canon. Future edits must be applied to active canonical docs instead of promoting this file as a parallel active spec.
