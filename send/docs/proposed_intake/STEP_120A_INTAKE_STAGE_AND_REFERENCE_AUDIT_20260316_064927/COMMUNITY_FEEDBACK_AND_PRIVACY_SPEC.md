...
merge_note:
This intake/supporting document must not be promoted to active canon as a separate parallel truth source.
Its bounded canonical content has been merged into the active canonical documents listed above.
Future updates must be applied to active canon, not here.
