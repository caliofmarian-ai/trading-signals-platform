...
4. FSM_DECISION_ENGINE_SPEC_v1.0.0.md


5. DECISION_OBJECT_CANONICAL_SPEC_v1.0.0.md
...
Aceste opt documente formează stack-ul strategic activ.
...
legacy/superseded signal-time history doc
...
time-model outputs defined by unified time canon
...
execution expiry fields as delivery outputs derived from canonical time semantics
...
calculul time-model outputs defined by unified time canon
...
livrarea unui contract runtime clar către signal engine
...
2. legacy/superseded signal-time history doc
...
2. SIGNAL_ENGINE_EXECUTION_SPEC_v2.0.0.md


3. CANONICAL_CODE_ALIGNMENT_MATRIX_v1.0.0.md
...
1. patch canonical/active/TIME_MODEL_UNIFIED_CANON_v2.0.0.md


2. patch legacy/superseded signal-time history doc


3. patch SIGNAL_ENGINE_EXECUTION_SPEC_v2.0.0.md


4. patch CANONICAL_CODE_ALIGNMENT_AUDIT_v1.0.0.md


5. patch IMPLEMENTATION_STEP_PLAN_v1.0.0.md


6. patch documente runtime / architecture care omit DecisionObject


7. aplicare status deprecated pe documentele legacy candidate


8. re-audit complet


9. abia apoi refactor major de cod
